...
class FaceRestoreHelper(object):
    ...
    def get_face_landmarks_5(self,
        ...
        with torch.no_grad():
            ...
            # bboxes = self.face_det.detect_faces(input_img, 0.97, use_origin_size=False) * scale
        for bbox in bboxes:
    ...
    def align_warp_face(self, save_cropped_path=None, border_mode='constant'):
        ...
        for idx, landmark in enumerate(self.all_landmarks_5):
            ...
            template_mean = np.mean(self.face_template, axis=0).reshape((1,2))
            face_template = (self.face_template - template_mean) * 1 + template_mean # Test
